...
public class PacketHandler {
    ...
    public static final void sendToAllAround(final IMessage message, final int dimension, final double x, final double y, final double z,
            final double range) {
    ...
    public static final void sendToAllAround(final IMessage message, final TileEntity tileEntity, final double range) {
        sendToAllAround(message, tileEntity.getWorld().provider.getDimension(), tileEntity.getPos().getX() + 0.5, tileEntity.getPos().getY() + 0.5,
                tileEntity.getPos().getZ() + 0.5, range);
    }
