...
public class ASMMethods {
    ...
    /*
     * public static void modelEvent(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float
     * headPitch, float scaleFactor, Entity entity, RenderLivingBase<?> render) { MinecraftForge.EVENT_BUS.post(new
     * ModelRotationEvent(render, scaleFactor, scaleFactor, scaleFactor, scaleFactor, scaleFactor, scaleFactor, entity)); }
     */
    ...
    public static void modelPlayerEvent(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch,
        ...
        if(model instanceof ModelPlayer)
            MinecraftForge.EVENT_BUS.post(new ModelPlayerRenderEvent((ModelPlayer) model, entity, scaleFactor, scaleFactor, scaleFactor, scaleFactor,
    ...
    public static ItemStack layerHeldItemEvent(EntityLivingBase entity, ItemStack stack, EnumHand hand) {
        /*
         * LayerHeldItemEvent event = new LayerHeldItemEvent(entity, stack, hand); MinecraftForge.EVENT_BUS.post(event); return
         * event.getStack();
         */
