...
public final class Round extends FunctionalValue {

    private final ExpValue value;

    public Round(ExpValue value) {
        super(value);
        this.value = value;
    }
    ...
    public double get(VariableMap vars) {
        return Math.round(this.value.get(vars));
    }

    @Override
    public String toString() {
        return String.format("round(%s)", this.value);
    }
}
