...
/**
 * Add to any entity renderer where the rider should be adjusted according to the entities model
 */
public class RiderEntityLayer<T extends LivingEntity, M extends EntityModel<T> & RideableModel<T>> extends RenderLayer<T, M> {
